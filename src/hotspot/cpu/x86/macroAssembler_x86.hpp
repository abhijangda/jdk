...
class MacroAssembler: public Assembler {
 ...
 virtual void check_and_handle_earlyret(Register java_thread);
  ...
  void append_heap_event(Universe::HeapEventType heap_event_type, RegisterOrAddress dst_or_new_obj, RegisterOrConstant src_or_obj_size, bool preserve_flags = false);
