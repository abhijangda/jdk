...
class GraphKit : public Phase {
 ...
 bool method_found() {
    ...
    bool found = //strstr(holder_name, "org/h2/command/") != NULL || 
                ...
                //  strstr(holder_name, "org/h2/index/Index") != NULL || 
                ...
                //  strstr(holder_name, "org/h2/index/ScanIndex") != NULL || 
                 strcmp(holder_name, "org/h2/index/TreeIndex") == 0;
    if (found) {
      found = (
  ...
  bool _method_found2;
  bool method_found2() { return false; 
  //return _method_found2;
  }
  bool _method_found3;
  bool method_found3() {return _method_found3;}
  ...
  bool method_found2_() {
    ...
    bool found = //strstr(holder_name, "org/h2/command/") != NULL || 
                 ...
                 //strstr(holder_name, "org/h2/expression/") != NULL || 
                 //strstr(holder_name, "org/h2/table/") != NULL || 
                 strstr(holder_name, "org/h2/") != NULL || 
  ...
  bool method_found3_() {
    ...
    bool found = //strstr(holder_name, "org/h2/command/") != NULL || 
                 ...
                 //strstr(holder_name, "org/h2/expression/") != NULL || 
                 //strstr(holder_name, "org/h2/table/") != NULL || 
                 strstr(holder_name, "org/h2/index") != NULL || 
                //  strstr(holder_name, "org/h2/index/Base") != NULL || 
                //  strstr(holder_name, "org/h2/index/Scan") != NULL || 
                //  strstr(holder_name, "org/h2/index/Tree") != NULL || 
                //  strstr(holder_name, "org/h2/index/View") != NULL || 
