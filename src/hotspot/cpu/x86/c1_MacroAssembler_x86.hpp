...
// C1_MacroAssembler contains high-level macros for C1
 ...
 public:
  ...
  // slow_case  : exit to slow case implementation if fast allocation fails
  void allocate_array(Register obj, Register len, Register t, Register t2, BasicType bt, int header_size, Address::ScaleFactor f, Register klass, Label& slow_case);
